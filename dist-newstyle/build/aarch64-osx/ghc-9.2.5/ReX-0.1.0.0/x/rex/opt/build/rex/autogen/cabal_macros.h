...
/* package ReX-0.1.0.0 */
#ifndef VERSION_ReX
#define VERSION_ReX "0.1.0.0"
#endif /* VERSION_ReX */
#ifndef MIN_VERSION_ReX
#define MIN_VERSION_ReX(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ReX */
...
#define CURRENT_COMPONENT_ID "ReX-0.1.0.0-inplace-rex"
